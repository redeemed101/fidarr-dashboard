 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query getGenresPaging($page:Int, $size :Int){\n    genresPaging(page:$page,size:$size){      \n        count\n        genres{\n          id\n          name\n          imageUrl\n          lastUpdated\n          dateCreated\n          songs{\n             id\n             name\n          }\n          artists{\n            id\n            name\n          }\n          albums{\n            id\n            name\n          }\n        }\n        \n    }\n}"): (typeof documents)["query getGenresPaging($page:Int, $size :Int){\n    genresPaging(page:$page,size:$size){      \n        count\n        genres{\n          id\n          name\n          imageUrl\n          lastUpdated\n          dateCreated\n          songs{\n             id\n             name\n          }\n          artists{\n            id\n            name\n          }\n          albums{\n            id\n            name\n          }\n        }\n        \n    }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
