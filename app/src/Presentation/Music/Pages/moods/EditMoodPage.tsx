...
import { PrimaryButton, ButtonWithIcon } from "../../../Common/buttons";
...
export const EditMoodPage = () => {
    const mood = useSelector((state: RootState) => state.selectedMood.Mood);
    ...
    useEffect(() => {
        ...
        setSelectedPlaylists(mood?.playlists!!)
      }, []);
            ...
            <form className='mx-auto' onSubmit={handleSubmit(onSubmit)}>
              <div className="flex flex-col mx-auto pt-12">
                  <div className="flex flex-col">
                    <p className="text-white font-bold pb-4">Edit Mood</p>
                    {fetchStatus == RequestStatus.Error ? <p className='text-red-600'>Error creating playlist</p> : ""}
                    {moodModified ?? <p className='text-blue-600'>Mood successfully edited</p> }
                  </div>
