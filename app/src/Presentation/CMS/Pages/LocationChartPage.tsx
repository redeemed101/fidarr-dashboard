        ...
        <div className="flex   gap-4 flex-col w-full">
            ...
            <div className="flex flex-col w-3/4 px-12 gap-4 mx-auto">
               ...
               <div className="flex flex-row items-center justify-between w-full">
                  <p className="font-bold text-white">Charts</p>
               ...
               <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col  bg-red-900 gap-2 rounded">
                            <div className="flex flex-col px-4 gap-2">
                                <div>
                                    <p className="font-bold text-white text-sm">Daily Charts</p>
                        ...
                        <div className="flex flex-col  bg-red-900 gap-2 rounded">
                            <div className="flex flex-col px-4 gap-2">
                                <div>
                                    <p className="font-bold text-white text-sm">Top Playlists</p>
                                    <p className="text-fidarrgray-300 text-sm">Content</p>
                                </div>
                                <div className="flex flex-row gap-2 items-baseline">
