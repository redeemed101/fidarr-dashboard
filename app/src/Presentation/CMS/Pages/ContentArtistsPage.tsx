        ...
        <div className="flex   gap-4 flex-col w-full">
            ...
            <div className="flex flex-col w-3/4 px-12 gap-4 mx-auto">
               ...
               <div className="flex flex-row items-center justify-between w-full">
                  <p className="font-bold text-white">Popular Artists</p>
               ...
               <div className="flex grid grid-cols-4 gap-4">
               {
                 [...Array(12)].map((x,i) => 
                       ...
                       <div className="flex flex-col gap-4 relative py-2 rounded">
                             
                            <img className="rounded-full" src={Playlist1} />
                             
                             <div className="self-center">
                                    <p className="font-bold text-white text-sm">Sinach</p>
                                    
                             </div> 
                             <div className="flex flex-row gap-2 pt-4 pr-4 absolute left-1/3 bottom-1/4">
...
export default ContentArtistsPage