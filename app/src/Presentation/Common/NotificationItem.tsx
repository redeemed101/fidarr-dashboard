...
const NotificationItem = ({hasNotification = false}: NotificationItemProps) => {
    return (
        <div>
           <div className="relative h-full w-full">
            <svg className="w-full h-full fill-white" id="Layer_1"  version="1.1" viewBox="0 0 512 512"  xmlns="http://www.w3.org/2000/svg" >
                <g>
            ...
            { hasNotification ? <div className="absolute top-0 right-0 h-1/4 w-1/4 my-2 mx-2 rounded-full bg-red-900 z-2"></div> : <></> }
           </div>
        </div>
    )
}
